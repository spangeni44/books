...
@section('content')
	<div>
		<h1 class="page-header text-overflow">{{ translate('Add New Audio Book') }}</h1>
	</div>
	<div class="row">
		<div class="col-lg-8 col-lg-offset-2">
			<form class="form form-horizontal mar-top" action="{{route('audioproducts.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
				@csrf
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-lg-7">
								<input type="text" class="form-control" name="name" placeholder="{{translate('Book Name')}}" required>
							</div>
						</div>
						<div class="form-group">
    						<label class="col-lg-2 control-label">{{translate('Book Version')}}</label>
    						<div class="col-lg-7">
    							<input type="number" class="form-control" name="book_version" required>
    						</div>
    					</div>
						<div class="form-group">
    						<label class="col-lg-2 control-label">{{translate('Book Author(s)')}}</label>
    						<div class="col-lg-7">
    							<input type="text" class="form-control" name="author_name[]" placeholder="{{ translate('Type to add author') }}" data-role="tagsinput">
    						</div>
    					</div>
    					<div class="form-group">
    						<label class="col-lg-2 control-label">{{translate('Book Reader(s)')}}</label>
    						<div class="col-lg-7">
    							<input type="text" class="form-control" name="book_reader[]" placeholder="{{ translate('Type to add book readers') }}" data-role="tagsinput">
    						</div>
    					</div>
    					...
    					<div class="form-group">
    						...
    						<div class="col-lg-7">
    							<input type="number" class="form-control" name="trial_time" required>
    						</div>
    					</div>
					    <div class="form-group">
    						<label class="col-lg-2 control-label">{{translate('No of Pages')}}</label>
    						<div class="col-lg-7">
    							<input type="number" class="form-control" name="no_of_pages" min="1" required>
    						</div>
    					</div>
    					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-lg-7">
								<input type="file" accept="audio/*" class="form-control" name="file" required>
							</div>
						</div>
						<div class="form-group">
				...
				<div class="panel">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-lg-7">
								<input type="number" min="0" value="0" step="0.01" placeholder="{{translate('Per Day Price')}}" name="price_per_day" class="form-control" required>
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-2 control-label">{{translate('Price Per Week')}}</label>
							<div class="col-lg-7">
								<input type="number" min="0" value="0" step="0.01" placeholder="{{translate('Per Week Price')}}" name="price_per_week" class="form-control" required>
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-2 control-label">{{translate('Price Per month')}}</label>
							<div class="col-lg-7">
								<input type="number" min="0" value="0" step="0.01" placeholder="{{translate('Per Month Price')}}" name="price_per_month" class="form-control" required>
							</div>
						</div>
						<div class="form-group">
				...
				<div class="panel">
					<div class="panel-heading bord-btm">
						<h3 class="panel-title">{{translate('Book Information')}}</h3>
					</div>
					<div class="panel-body">
						<div class="form-group">
							<label class="col-lg-2 control-label">{{translate('Description')}}</label>
