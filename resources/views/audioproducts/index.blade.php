...
<div class="row">
    <div class="col-lg-12">
        <a href="{{ route('audioproducts.create')}}" class="btn btn-rounded btn-info pull-right">{{translate('Add New Audio Book')}}</a>
    </div>
</div>
...
<div class="col-lg-12">
    <div class="panel">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">{{ translate('Audio Books') }}</h3>
        </div>
                            ...
                            <td>
                                <div class="btn-group dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="{{route('audioproducts.edit', encrypt($product->id))}}">{{translate('Edit')}}</a></li>
                                        <li><a onclick="confirm_modal('{{route('audioproducts.destroy', $product->id)}}');">{{translate('Delete')}}</a></li>
                                        <li><a href="{{route('audioproducts.download', encrypt($product->id))}}">{{translate('Download')}}</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
