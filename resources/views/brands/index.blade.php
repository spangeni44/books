...
<div class="row">
    <div class="col-sm-12">
        <a href="{{ route('publications.create')}}" class="btn btn-rounded btn-info pull-right">{{translate('Add New Publication')}}</a>
    </div>
</div>
            ...
            <tbody>
                ...
                @foreach($publications as $key => $publication)
                    <tr>
                        ...
                        <td><img loading="lazy"  class="img-md" src="{{ my_asset($publication->logo) }}" alt="Logo"></td>
                        <td>
