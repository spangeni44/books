    ...
    <div class="col-md-6">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <br>
                <p class="text-lg text-main">{{translate('Total published books')}}: <span class="text-bold">{{ \App\Product::where('published', 1)->get()->count() }}</span></p>
                ...
                @endif
                <p class="text-lg text-main">{{translate('Total admin books')}}: <span class="text-bold">{{ \App\Product::where('published', 1)->where('added_by', 'admin')->get()->count() }}</span></p>
                <br>
                <a href="{{ route('products.admin') }}" class="btn btn-primary mar-top">{{ translate('Manage Books') }} <i class="fa fa-long-arrow-right"></i></a>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="row">
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">{{translate('Total book category')}}</p>
                ...
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">{{translate('Total book sub sub category')}}</p>
            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">{{translate('Total book sub category')}}</p>
                ...
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">{{translate('Total book publications')}}</p>
                        <p class="text-semibold text-3x text-main">{{ \App\Publication::all()->count() }}</p>
                        <a href="{{ route('publications.create') }}" class="btn btn-primary mar-top btn-block top-border-radius-no">{{translate('Create Publication')}}</a>
                    </div>
                </div>
            </div>
        </div>
...
@if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
    ...
    <div class="col-md-6">
        <div class="panel">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">{{translate('Category wise book sale')}}</h3>
            </div>
    ...
    <div class="col-md-6">
        <div class="panel">
            <!--Panel heading-->
            <div class="panel-heading">
                <h3 class="panel-title">{{translate('Category wise book stock')}}</h3>
            </div>
