			...
			<form class="form form-horizontal mar-top" action="{{route('digitalproducts.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
				...
				<div class="panel">
					...
					<div class="panel-body">
    					...
    					<div class="form-group">
    						<label class="col-lg-2 control-label">{{translate('Trial Pages')}}</label>
    						<div class="col-lg-7">
    							<input type="number" class="form-control" value="{{@$product->trial_pages}}" name="trial_pages" required>
    						</div>
    					</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-lg-2 control-label">{{translate('Book File')}}</label>
							<div class="col-lg-7">
