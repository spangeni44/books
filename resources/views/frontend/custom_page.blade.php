...
@endsection
<!--<div class="container-fluid" style="box-shadow:1px 1px 1px 5px silver;">-->
    @section('content')
<!--</div>-->
...
<!--    </div>-->
<!--</section>-->
<section class="bg-white" style="margin-top:0px;">
    <!--py-5-->
	<div class="container" style="padding-top:0px!important; margin-top:0px !important;">
        <div class="aiz-custom-page" style="padding-top:0px !important; margin-top:0px !important;">   
