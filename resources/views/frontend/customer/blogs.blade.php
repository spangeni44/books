                    ...
                    <div class="main-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mx-auto">
                                <a class="dashboard-widget text-center plus-widget mt-4 d-block" href="{{ route('customer-blogs.create')}}">
                                    ...
                                    <tbody>
                                        @foreach ($blogs as $key => $blog)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('customer-blogs.edit', encrypt($blog->id))}}" class="btn btn-primary" style="border-radius:10%; padding:10px;"><i class="fa fa-pencil"></i></a>
					                                <button onclick="confirm_modal('{{route('customer-blogs.destroy', $blog->id)}}')" class="btn btn-danger" style="border-radius:10%; padding:10px;"><i class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
