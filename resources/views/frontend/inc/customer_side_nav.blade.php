    ...
    <div class="widget mb-0">
        ...
        <div class="widget-profile-menu py-3">
            <ul class="categories categories--style-3">
                ...
                <li>
                    <a href="{{ route('compare') }}" class="{{ areActiveRoutesHome(['compare'])}}">
                        <i class="la la-heart-o"></i>
                        <span class="category-name">
                            {{translate('Compare')}}
                        </span>
                ...
                @endif
                 <li>
                    <a href="{{ route('customer-blogs.index') }}" class="{{ areActiveRoutesHome([' customer-blogs.index'])}}">
                        <i class="la la-book"></i>
                        <span class="category-name">
                            {{translate('Your Blogs')}}
                        </span>
                    </a>
                </li>
