            ...
            <ul class="categories categories--style-3">
                ...
                <li>
                    <a href="{{ route('seller.digitalproducts') }}" class="{{ areActiveRoutesHome(['seller.digitalproducts', 'seller.digitalproducts.upload', 'seller.digitalproducts.edit'])}}">
                        <i class="la la-diamond"></i>
                        <span class="category-name">
                            {{ translate('Digital Books')}}
                        </span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('seller.audioproducts') }}" class="{{ areActiveRoutesHome(['seller.audioproducts', 'seller.audioproducts.upload', 'seller.audioproducts.edit'])}}">
                        <i class="la la-diamond"></i>
                        <span class="category-name">
                            {{ translate('Audio Books')}}
                        </span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('author-blogs.index') }}" class="{{ areActiveRoutesHome(['author-blogs.index'])}}">
                        <i class="la la-file-text"></i>
                        <span class="category-name">
                            {{ translate('Blogs')}}
                        </span>
