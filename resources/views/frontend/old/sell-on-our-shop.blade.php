...
<div class="header-affiliate">
	...
	<div class="row">
		<div class="col-md-6 left-column">
			<h3>Become a vendor on Go Bazaar</h3>
			<!-- <h2>Goto</h2> -->
...
<div class="six-column-wraper">
	<div class="container"><div class="row">
		...
		<div class="col col-md-4 col-sm-6 col-6"><div class="block-sop">
			...
			<div class="block ">
				<h3>Easy Payment</h3>
				<p class="comments">"Go Bazaar pays sellers conveniently via IBFT on mutually agreed credit days whenever their product is sold through our website.</p>
			</div>
		</div></div>
		<div class="col col-md-4 col-sm-6 col-6"><div class="block-sop">
			...
			<div class="block ">
				...
				<p class="comments">You have the choice to deliver your products to the customers yourself or let Go Bazaar manage the delivery of the orders to customers.</p>
			</div>
		</div></div>
		<div class="col col-md-4 col-sm-6 col-6"><div class="block-sop">
			...
			<div class="block">
					<h3>Easy Return</h3>
					<p class="comments text-center">Go Bazaar has an easy returns policy for customers and sellers. If a customer returns a product, we supply it back to you within a few days.</p>
			</div>
		</div></div>
		<div class="col col-md-4 col-sm-6 col-6"><div class="block-sop">
		...
		<div class="col col-md-4 col-sm-6 col-6"><div class="block-sop">
			...
			<div class="block">
				...
				<p class="comments">Go Bazaar promotes your products through various channels such as email, SMS, Facebook, Instagram, etc. without charging you anything.</p>
			</div>
		</div></div>
	</div></div>
</div>
...
<div class="faq-accordian">
    ...
    <div class="card-header" id="headingOne">
      <h5 class="mb-0">
        <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
          What is Go Bazaar Sellers Signup?<span class="arrow-icon"></span>
        </button>
      </h5>
    </div>
  ...
  <div class="card">
    ...
    <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordion">
      <div class="card-body">
        <p>No. Go Bazaar does not charge vendors any joining fee.</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="card-header" id="headingeight">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseeight" aria-expanded="false" aria-controls="collapseeight">
          How much does Go Bazaar charge when my product is purchased?<span class="arrow-icon"></span>
        </button>
      </h5>
    </div>
    ...
    <div class="card-header" id="headingnine">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapsenine" aria-expanded="false" aria-controls="collapsenine">
          Which channels does Go Bazaar promote my products on?<span class="arrow-icon"></span>
        </button>
      </h5>
    </div>
    <div id="collapsenine" class="collapse" aria-labelledby="headingnine" data-parent="#accordion2">
      <div class="card-body">
       <p>Go Bazaar uses various channels such as Facebook, Google ads, Instagram, web notifications, emails, SMS, Affiliate marketing, etc. to promote products. </p>
      </div>
    </div>
  </div>
  <div class="card">
