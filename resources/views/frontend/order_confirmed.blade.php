		...
		<div class="breadcrumb-contents">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ translate('Order Confirmed')}}</a></li>
				</ol>
			</nav>
		</div>
	</div>
                                        ...
                                        <div class="col-md-6">
                                            <table class="details-table table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ json_decode($order->shipping_address)->address }}, {{ json_decode($order->shipping_address)->city }}, @if(isset(json_decode($order->shipping_address)->district)) {{ json_decode($order->shipping_address)->district }}, @endif {{ json_decode(@$order->shipping_address)->country }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <table class="table details-table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <!--for quantity calculation in jquery-->
                                                                <span class="hidden" id="total_quantity"></span>
                                                            <!--ends -->
                                                            
                                                            <span class="text-italic"> {{ single_price(json_decode($order->shipping_address)->shipping_charge) }}</span>
                                                        </td>
                                                    </tr>
                                                    <!--<tr>-->
                                                    <!--    <th>{{ translate('Tax')}}</th>-->
                                                    ...
                                                    <tr>
                                                        <th><span class="strong-600">{{ translate('Grand Total (including tax)')}}</span></th>
                                                        <td class="text-right">
