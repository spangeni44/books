...
@php
 ...
 $message_seller_template = "Dear Sir/Madam,
Your message...

Quantity:
Estimated Purchase Amount USD:

Product link: ".route('product', $detailedProduct->slug);
@endphp
    <!-- SHOP GRID WRAPPER -->
        ...
        <div class="container">
            ...
            <div class="bg-white">
                ...
                <div class="row no-gutters cols-xs-space cols-sm-space cols-md-space">
                    ...
                    <div class="col-lg-6">
                        <!-- Product description -->
                        <div class="product-description-wrapper" style="padding:0px">
                            <!--for flash sale timmer-->
                            @php
                                $flash_deal = \App\FlashDeal::where('status', 1)->where('featured', 1)->first();
                            @endphp
                             
                                @if($flash_deal->flash_deal_products->contains('product_id', $detailedProduct->id))
                               
                                <h5 class="heading-6 nrn-title-medium strong-700 mb-0 float-left pb-5" style="border-bottom:solid 1px orange; padding:5px !important;">Flash Sale <span style="font-size:13px;"> Ends in</span></h5>
                                   <div class="flash-deal-box clearfix" style="margin-bottom:10px !important; ">
                            ...
                            <!-- Product title -->
                            <h1 class="product-title mb-2" style="padding-left:0px;">
                            ...
                            <div class="row align-items-center">
                                <div class="sold-by col-auto">
                                 ...
                                 @if(isset($detailedProduct->sku))
                                    <div class="col-auto">
                                       <small class='mr-2'>{{ translate('SKU')}}: </small><br>
                                       <a>{{@$detailedProduct->sku}}</a>
                                    </div>
                                @endif
                            ...
                            @if(home_price($detailedProduct->id) != home_discounted_price($detailedProduct->id))
                                    ...
                                    <div class="col-9 col-md-10">
                                        <div class="product-price-old">
                                            ...
                                            <div class="product-price">
                                                 <strong>
                                                     <span style="font-size:20px;margin-left:8px; font-weight:bold;">
                                ...
                                <!--                 Rs {{preg_replace('/[^0-9]/', '',home_price($detailedProduct->id))*(preg_replace('/[^0-9]/', '',$discountValue))/100}}-->
                                <!--                  @if($detailedProduct->unit != null)-->
                                <!--                    <sub >/{{ $detailedProduct->unit }}</sub>-->
                                <!--                @endif-->
                                ...
                                <!--</div>-->
                                     ...
                                     @if(isset($detailedProduct->warrenty))
                                    <div class="row no-gutter mt-4">
                                        <div class="col-3 col-md-2">
                                            <div class="product-description-label">{{ translate('Warranty')}}:</div>
                                        </div>
                                        <div class="col-4 col-md-4">
                                            <div class="">
                                                <strong>
                                                    {{@$detailedProduct->warrenty }}
                                                </strong>
                                ...
                                <div class="row no-gutters mt-3">
                                    ...
                                    @if(isset($detailedProduct->warrenty))
                                        ...
                                        <div class="col-3 col-md-4">
                                            <div class="product-warranty-data">
                                                <p>{{$detailedProduct->warrenty}}</p>
                            ...
                            <div class="row no-gutters">
                                        <div class="col-3 col-md-2">
                                            <div class="product-description-label mt-2">{{ translate('Key Features')}}:</div>
                                        </div>
                                        <div class="col-9 col-md-10">
                                            <p class="text-gray">{!! $detailedProduct->excerpt !!}</p>
                                        </div>
                                    </div>
                            ...
                            <form id="option-choice-form">
                                ...
                                <!--<div class="row no-gutters">-->
                                <!--    <div class="col-3 col-md-2">-->
                                <!--        <div class="product-description-label mt-2">{{ translate('Shiping Address')}}:</div>-->
                                <!--    </div>-->
                                <!--    <div class="col-9 col-md-10">-->
                                <!--        <div class="shipping-address d-flex align-items-center">-->
                                <!--             <div class="form-group">-->
                                <!--              <select class="form-control" name= "shipping_address" id="shipping-address" product_id="{{$detailedProduct->id}}">-->
                                ...
                                <!--delivery charge-->
                                <!--<div class="row no-gutters pb-3 d-none" id="delivery_charge_div">-->
                                <!--    <div class="col-3 col-md-2">-->
                                <!--        <div class="product-description-label">{{ translate('Delivery Charge')}}:</div>-->
                                <!--    </div>-->
                                <!--    <div class="col-9 col-md-10">-->
                                <!--        <div class="delivery_charge">-->
                                <!--            <strong id="delivery_charge">-->
    ...
    <section class="gry-bg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9">
                        ...
                        <div class="tabs tabs--style-2">
                            <ul class="nav nav-tabs justify-content-center sticky-top bg-white">
                                <li class="nav-item">
                                 ...
                                 @if ($detailedProduct->user->seller && $detailedProduct->user->shop->company_profile)
                                <li class="nav-item">
                                    <a href="#tab_company_profile" data-toggle="tab" class="nav-link text-uppercase strong-600">
                                        Company Profile
                                    </a>
                                </li>
                                @endif
                            ...
                            <div class="tab-content pt-0">
                                ...
                                @if ($detailedProduct->user->seller && $detailedProduct->user->shop->company_profile)
                                <div class="tab-pane" id="tab_company_profile">
                                    <div class="py-2 px-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mw-100 overflow--hidden aiz-product-description">
                                                    {!! $detailedProduct->user->shop->company_profile !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="fluid-paragraph py-2">
                                        ...
                                        <div class="embed-responsive embed-responsive-16by9 mb-5">
                                            @if ($detailedProduct->video_provider == 'youtube' && $detailedProduct->video_link != null)
                                                ...
                                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/{{ strstr(explode('=', $detailedProduct->video_link)[1],'&',true) }}"></iframe>
                    ...
                    <!--                    <div class="product-btns clearfix d-flex justify-content-center" style="left: 10px">-->
                    <!--                        <button class="btn add-wishlist view-product" style="left: 70px;" title="Quick VIew" onclick="showAddToCartModal({{ $related_product->id }})" tabindex="0">-->
                    <!--                            <i class="la la-eye"></i>-->
                    <!--                        </button>-->
                    <!--                        <button class="btn quick-view" title="Quick view" onclick="addToCart({{ $related_product->id }})" tabindex="0">-->
                    <!--                            <i class="fa fa-shopping-bag"></i>-->
                    <!--                        </button>-->
                    <!--                        <button class="btn add-wishlist" title="Add to Wishlist" onclick="addToWishList({{ $related_product->id }})" tabindex="0">-->
                    <!--                            <i class="la la-heart-o"></i>-->
                    <!--                        </button>-->
                                            <!--<button class="btn add-compare" title="Add to Compare" onclick="addToCompare({{ $related_product->id }})" tabindex="0">-->
                   ...
                   <div class="seller-top-products-box bg-white sidebar-box mb-12">
                        <div class="box-title">
                            {{ translate('Related Products')}}
                        </div>
                        <div class="row">
                            @foreach (filter_products(\App\Product::where('subcategory_id', $detailedProduct->subcategory_id)->where('id', '!=', $detailedProduct->id))->limit(4)->get() as $key => $top_product)
                            <div class="col-md-3">
                                
                              
                                <div class=" product-box-2 alt-box my-2">
                                    <!--clearfix-->
                                    <div class="product-image" style="margin-right:5px;">
                                        <!--float-left-->
                                        <a href="{{ route('product', $top_product->slug) }}">
                                            <img class="img-fit lazyload" src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($top_product->thumbnail_img) }}" style="min-height:233px;" alt="{{  translate($top_product->name) }}">
                                        </a>
                                        <!--added for buttons-->
                                        <div class="product-btns  d-flex justify-content-center" style="left: 10px">
                                            <!--clearfix-->
                                            <button class="btn add-wishlist view-product" style="left:38%; " title="Quick VIew" onclick="showAddToCartModal({{ $top_product->id }})" tabindex="0">
                                                <!--70px;-->
                                                <i class="la la-eye"></i>
                                            </button>
                                            <button class="btn quick-view" title="Add to Cart" onclick="addToCart({{ $top_product->id }})" tabindex="0" style="margin-right:20%; top: -100px !important;">
                                                <i class="fa fa-shopping-cart"></i>
                                            </button>
                                            <button class="btn add-wishlist" title="Add to Wishlist" onclick="addToWishList({{ $top_product->id }})" style="margin-right:20%; top: -100px !important;" tabindex="0">
                                                <i class="la la-heart-o"></i>
                                            </button>
                                            <button class="btn add-compare" title="Add to Compare" onclick="addToCompare({{ $top_product->id }})" style="margin-right:5%; top: -100px !important;" tabindex="0">
                                                <i class="la la-refresh"></i>
                                            </button>
                                    ...
                                    <div class="product-details ">
                                        <!--float-left-->
                                        <h4 class="title text-truncate">
                                            <a href="{{ route('product', $top_product->slug) }}" class="d-block" style="font-size:14px; margin-right:5px;">{{ $top_product->name }}</a>
                                        </h4>
                                        <div class="star-rating star-rating-sm mt-1">
                                            {{ renderStarRating($top_product->rating) }}
                                        </div>
        ...
        <!--            <span>{{ translate('Related Products')}}</span>-->
        <!--        </h3>-->
        <!--    </div>-->
        <!--    <div class="caorusel-box arrow-round gutters-5">-->
        ...
        <!--            @foreach (filter_products(\App\Product::where('subcategory_id', $detailedProduct->subcategory_id)->where('id', '!=', $detailedProduct->id))->limit(5)->get() as $key => $product)-->
        <!--            <div class="caorusel-card">-->
        <!--                <div class="product-box-2 bg-white alt-box my-2">-->
        <!--                    <div class="position-relative overflow-hidden">-->
        ...
        <!--                                <i class="la la-eye"></i>-->
        <!--                            </button>-->
        <!--                            <button class="btn quick-view" title="Quick view" onclick="addToCart({{ $product->id }})" tabindex="0">-->
        <!--                                <i class="fa fa-shopping-bag"></i>-->
        <!--                            </button>-->
            ...
            <div class="modal-content position-relative">
                ...
                <form class="" action="{{ route('conversations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="8" name="message" required placeholder="{{ translate('Your Question') }}">{{ $message_seller_template }}</textarea>
                        </div>
                    </div>
