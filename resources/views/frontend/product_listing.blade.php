...
<section class="breadcrumb-section">
	<h2 class="sr-only">{{.env('APP_NAME','Pustak')}}</h2>
	<div class="container">
            ...
            <form class="" id="search-form" action="{{ route('search') }}" method="GET">
                ...
                <div class="col-xl-9">
                    <!-- <div class="bg-white"> -->
                                        ...
                                        <div class="product-box-2 bg-white alt-box my-md-2">
                                            <div class="position-relative overflow-hidden">
                                                ...
                                                <div class="product-btns clearfix d-flex justify-content-between" style="left: 10px">
                                                    <button class="btn add-wishlist view-product" style="left: 64px;" title="Quick VIew" onclick="showAddToCartModal({{ $product->id }})" tabindex="0">
                                                        <i class="la la-eye"></i>
                                                    </button>
                        ...
                        @if(isset($category_id))
                            <div class="container">
                                @if(isset(\App\Category::find($category_id)->meta_description))
                                
                                    {!! \App\Category::find($category_id)->meta_description !!}
                                @endif
                            </div>
                        @elseif(isset($subcategory_id))
                             <div class="container">
                                @if(isset(\App\SubCategory::find($subcategory_id)->meta_description))
                                    {!! \App\SubCategory::find($subcategory_id)->meta_description !!}
                                @endif
                            </div>
                        @endif
                        </div>
