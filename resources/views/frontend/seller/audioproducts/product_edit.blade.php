                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h2 class="heading heading-6 text-capitalize strong-600 mb-0">
                                        {{translate('Update your Audio Book')}}
                                    </h2>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <!--        <li><a href="{{ route('seller.audioproducts') }}">{{translate('Audio Books')}}</a></li>-->
                                    <!--        <li class="active"><a href="{{ route('seller.audioproducts.edit', $product->id) }}">{{translate('Edit Audio Book')}}</a></li>-->
                                    <!--    </ul>-->
                                    <!--</div>-->
                                </div>
                            </div>
                        </div>
                        <form class="" action="{{route('audioproducts.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name" placeholder="{{translate('Book Name')}}" value="{{ $product->name }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="book_version" placeholder="{{translate('Book Version')}}" value="{{ $product->book_version }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="author_name[]" placeholder="{{translate('Book Author(s)')}}" value="{{ $product->author_name }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="book_reader[]" placeholder="{{translate('Book Reader(s)')}}" value="{{ $product->book_reader }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="no_of_pages" placeholder="{{translate('No of Pages" value="{{@$product->no_of_pages}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="date" name="publish_date" value="{{@$product->publish_date}}"  class="form-control mb-3" placeholder="{{translate('Book Publish Date')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="trial_time" class="form-control mb-3" value="{{@$product->trial_time}}" placeholder="{{translate('Trial time')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="date" name="duration" value="{{@$product->duration}}" class="form-control mb-3" placeholder="{{translate('Book Publish Date')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{translate('Book Tag')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-2">
                                            <label>{{translate('Audio File')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="file" accept="audio/*" name="file" id="file-6" class="custom-input-file custom-input-file--4" data-multiple-caption="{count} files selected" />
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
            							...
            							<div class="col-lg-10">
            								<input type="number" min="0" value="0" step="0.01" placeholder="{{translate('Per Day Price')}}" name="price_per_day" value="{{@$product->price_per_day}}" class="form-control mb-3" required>
            							</div>
            						</div>
            						<div class="row">
                                        <div class="col-md-2">
            							...
            							<div class="col-lg-10">
            								<input type="number" min="0" value="0" step="0.01" placeholder="{{translate('Per Week Price')}}" name="price_per_week" value="{{@$product->price_per_week}}" class="form-control mb-3" required>
            							</div>
            						</div>
            						<div class="row">
                                        <div class="col-md-2">
            							...
            							<div class="col-lg-10">
            								<input type="number" min="0" value="0" step="0.01" placeholder="{{translate('Price Per Month')}}" name="price_per_month" value="{{@$product->price_per_month}}" class="form-control mb-3" required>
            							</div>
            						</div>
                                    <div class="row">
                                        <div class="col-md-2">
