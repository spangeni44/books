                        ...
                        <div class="page-title">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!--        <li class="active"><a href="#">{{ translate('Add New Blog')}}</a></li>-->
                                    <!--    </ul>-->
                                    <!--</div>-->
                                </div>
                            </div>
                        </div>
                        <form class="" action="{{route('author-blogs.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            @csrf
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="blog_title" class="form-control mb-3" placeholder="{{ translate('Blog Title')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="slug" class="form-control mb-3" placeholder="{{ translate('Blog Slug')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Featured Image')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                            ...
                            <div class="form-box mt-4 text-right">
                                <button type="submit" class="btn btn-styled btn-base-1">{{  translate('Post') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
