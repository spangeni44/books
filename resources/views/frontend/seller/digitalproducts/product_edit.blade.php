                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="book_version" placeholder="{{ translate('Book Version')}}" value={{@$product->book_version}} required>
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="book_author[]" placeholder="{{ translate('Book Author(s)') }}" value="{{@$product->book_author}}" data-role="tagsinput" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{translate('Book Category')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                						...
                						<div class="col-md-10">
            						    	<select class="form-control demo-select2-placeholder" name="publication_id" id="publication_id">
                								...
                								@foreach (\App\Publication::all() as $publication)
                									<option value="{{ $publication->id }}" @isset(@$product->publication_id) @if(@$product->publication_id==@$publication->id) selected @endif @endisset >{{ $publication->name }}</option>
                								@endforeach
            							    </select>
                						</div>
							        </div>
							        <div class="row">
                						...
                						<div class="col-lg-7">
                							<input type="date" class="form-control mb-3" name="publish_date" value="{{@$product->publish_date}}" required>
                						</div>
                					</div>
                					<div class="row">
							            <div class="col-md-2">
                						    <label>{{translate('Trial Pages')}}</label>
                						</div>
                						<div class="col-lg-7">
                							<input type="number" class="form-control mb-3" name="trial_pages" value="{{@$product->trial_pages}}" required>
                						</div>
                					</div>
                					<div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('No of Pages')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="no_of_pages" placeholder="{{ translate('No of Pages')}}" value="{{@$product->no_of_pages}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-2">
                                            <label>{{translate('Book File')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
