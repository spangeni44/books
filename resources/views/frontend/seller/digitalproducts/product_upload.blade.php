                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name" placeholder="{{ translate('Book Name')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="book_version" placeholder="{{ translate('Book Version')}}" required>
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="book_author[]" placeholder="{{ translate('Book Author(s)') }}" data-role="tagsinput" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
							        ...
							        <div class="row">
                						...
                						<div class="col-lg-7">
                							<input type="date" class="form-control mb-3" name="publish_date" required>
                						</div>
                					</div>
                					<div class="row">
							            <div class="col-md-2">
                						...
                						<div class="col-lg-7">
                							<input type="number" class="form-control mb-3" name="trial_pages" required>
                						</div>
                					</div>
                					<div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="no_of_pages" placeholder="{{ translate('No of Pages')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
