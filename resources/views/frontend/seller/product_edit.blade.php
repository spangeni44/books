                        ...
                        <form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                                ...
                                <div class="form-box-content p-3">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="min_qty" min="1" value="@if($product->min_qty <= 1){{1}}@else{{$product->min_qty}}@endif">
                                        </div>
                                    </div>
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Short Description Excerpt')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="mb-3">
