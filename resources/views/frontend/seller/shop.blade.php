                        ...
                        <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Company Profile <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <textarea name="company_profile" rows="6" class="form-control mb-3 editor" required>{{ $shop->company_profile }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
