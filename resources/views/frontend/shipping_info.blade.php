    		...
    		<div class="breadcrumb-contents">
    			<nav aria-label="breadcrumb">
    				<ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">{{ translate('Checkout')}}</a></li>
    				</ol>
    			</nav>
    		</div>
    	</div>
        ...
        <section class="py-4 gry-bg">
            <div class="container">
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-lg-7">
                        @php $contain_physical=false; foreach(Session::get('cart') as $ind_cart){ if(!$ind_cart['digital']){ $contain_physical=true;}} @endphp
                        {{--shopping Info--}}
                                ...
                                <table class="table-cart table-cart-review">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-total" style="float:right;">{{translate('Rate')}}</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach (Session::get('cart') as $key => $cartItem)
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <!--</td>-->
                                                <td><strong class="product-quantity"  style="text-align:right !important;">{{ $cartItem['quantity'] }}</strong></td>
                                ...
                                <table class="table-cart table-cart-review" style="width:70%; float:right;">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="cart-total">
                                            ...
                                            <td class="text-right">
                                                <strong><span id="total_without_shipping" class="text-italic">{{ single_price($total) }}</span>
                                                <span id='total_after_shipping' class="hidden text-italic">Rs. 0</span>
                                                </strong>
                                            </td>
                                        </tr>
                                    </tfoot>
...
<script type="text/javascript">
    ...
    function get_shipping_charge_by_city(){
		...
		$.post('{{ route('checkout.get_shipping_charge_by_city') }}',{_token:'{{ csrf_token() }}', city_id:city_id}, function(data){
            ...
            var extra = "";
		        var total_quantity="@php $total_qty=0; foreach(Session::get('cart') as $ind_cart){ if(!$ind_cart['digital']){ $total_qty+=$ind_cart['quantity'];}} echo $total_qty;  @endphp";
