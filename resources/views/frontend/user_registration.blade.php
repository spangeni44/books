					...
					<div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
                        <div class="">
                         ...
                         <div class="text-center">
                            <p class="text-md">
                                {{ translate('Already have an account?')}} <a href="{{ route('user.login') }}" class="strong-600" style="font-weight:600;">{{ translate('Log In')}}</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-sm-- col-md-3 col-lg-3 col-xs-0">
                    </div>
