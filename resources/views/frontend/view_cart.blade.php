    		...
    		<div class="breadcrumb-contents">
    			<nav aria-label="breadcrumb">
    				<ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">{{ translate('Cart')}}</a></li>
    				</ol>
    			</nav>
    		</div>
    	</div>
                ...
                <div class="modal-body">
                    ...
                    @if (\App\BusinessSetting::where('type', 'guest_checkout_active')->first()->value == 1)
                        ...
                        <div class="text-center">
                            <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1">{{ translate('Customer Checkout')}}</a>
                        </div>
                    @endif
                </div>
            </div>
