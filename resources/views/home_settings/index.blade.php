                ...
                <div class="panel">
                    ...
                    <form class="form-horizontal" action="{{ route('top_10_settings.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3" for="url">{{translate('Top Publications (Max 10)')}}</label>
                                <div class="col-sm-9">
                                    <select class="form-control demo-select2-max-10" name="top_publications[]" multiple>
                                        @foreach (\App\Publication::all() as $key => $publication)
                                            <option value="{{ $publication->id }}" @if($publication->top == 1) selected @endif>{{ $publication->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
