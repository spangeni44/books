                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                <a href="#">
                                    ...
                                    <span class="menu-title">{{translate('Books')}}</span>
                                    <i class="arrow"></i>
                                </a>

                                <!--Submenu-->
                                <ul class="collapse">
                                    <li class="{{ areActiveRoutes(['publications.index', 'publications.create', 'publications.edit'])}}">
                                        <a class="nav-link" href="{{route('publications.index')}}">{{translate('Publications')}}</a>
                                    </li>
                                    ...
                                    <li class="{{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit'])}}">
                                        <a class="nav-link" href="{{route('products.admin')}}">{{translate('In House Books')}}</a>
                                    </li>
                                    @if(\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                        <li class="{{ areActiveRoutes(['products.seller', 'products.seller.edit'])}}">
                                            <a class="nav-link" href="{{route('products.seller')}}">{{translate('Seller Books')}}</a>
                                        </li>
                                    @endif
                                    @if(\App\BusinessSetting::where('type', 'classified_product')->first()->value == 1)
                                        <li class="{{ areActiveRoutes(['classified_products'])}}">
                                            <a class="nav-link" href="{{route('classified_products')}}">{{translate('Classified Books')}}</a>
                                        </li>
                                    @endif
                                    <li class="{{ areActiveRoutes(['digitalproducts.index', 'digitalproducts.create', 'digitalproducts.edit'])}}">
                                        <a class="nav-link" href="{{route('digitalproducts.index')}}">{{translate('Digital Books')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['audioproducts.index', 'audioproducts.create', 'audioproducts.edit'])}}">
                                        <a class="nav-link" href="{{route('audioproducts.index')}}">{{translate('Audio Books')}}</a>
                                    </li>
                                    ...
                                    <li class="{{ areActiveRoutes(['reviews.index'])}}">
                                        <a class="nav-link" href="{{route('reviews.index')}}">{{translate('Book Reviews')}}@if($review_count > 0)<span class="pull-right badge badge-info">{{ $review_count }}</span>@endif</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        <li class="{{ areActiveRoutes(['blogs.index', 'blogs.create', 'blogs.edit'])}}">
                            <a class="nav-link" href="{{ route('blogs.index') }}">
                                <i class="fa fa-book"></i>
                                <span class="menu-title">{{translate('Blogs')}}</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <span class="menu-title">{{translate('Shipping Address Settings')}}</span>
                                <i class="arrow"></i>
                            </a>

                            <!--Submenu-->
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['inside_valley_shipping.index','inside_valley_shipping.store'])}}">
                                    <a class="nav-link" href="{{route('inside_valley_shipping.index')}}">{{translate('Inside Valley Shipping')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['shipping_district.index'])}}">
                                    <a class="nav-link" href="{{route('shipping_districts.index')}}">{{translate('Shipping District')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['shipping_district.index'])}}">
                                    <a class="nav-link" href="{{route('shipping_cities.index')}}">{{translate('Shipping City')}}</a>
                                </li>
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('6', json_decode(Auth::user()->staff->role->permissions)))
                         <li>
                            <a href="#">
                                <i class="fa fa-user-plus"></i>
                                <span class="menu-title">{{translate('Career')}}</span>
                                <i class="arrow"></i>
                            </a>

                            <!--Submenu-->
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['careers.index', 'careers.edit', 'careers.updateStatus'])}}">
                                  
                                    <a class="nav-link" href="{{route('careers.index')}}">{{translate('Job List')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['careers.create'])}}">
                                    <a class="nav-link" href="{{ route('careers.create') }}">{{translate('Open New Job')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['job-application-list'])}}">
                                    <a class="nav-link" href="{{ route('job-application-list') }}">{{translate('Job Applications')}}</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['wish_report.index'])}}">
                                    <a class="nav-link" href="{{ route('wish_report.index') }}">{{translate('Book Wish Report')}}</a>
                                </li>
                            </ul>
                        </li>
                        @endif
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['set_product_points', 'product_club_point.edit'])}}">
                                        <a class="nav-link" href="{{route('set_product_points')}}">{{translate('Set Book Point')}}</a>
                                    </li>
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="{{ areActiveRoutes(['menus.index'])}}">
                            <a class="nav-link" href="{{ route('menus.index') }}">
                                <i class="fa fa-gears"></i>
                                <span class="menu-title">{{translate('Menus')}}</span>
                            </a>
                        </li>
                        @endif
