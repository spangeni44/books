	...
	<div style="margin-left:auto;margin-right:auto;">
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
			<table>
				...
				<tr><td class="gry-color small"><b>@if(isset($shipping_address->inside_valley_address)) {{ucwords(str_replace('_',' ',@$shipping_address->inside_valley_address))}}, @else Outside Valley, @endif </b> {{ $shipping_address->address }}, {{ $shipping_address->city }}, @if(isset($shipping_address->district)) {{ $shipping_address->district }}, @endif {{ $shipping_address->country }}</td></tr>
	        ...
	        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
		        <tbody>
			        ...
			        <tr>
			            ...
			            <td class="currency">{{ single_price($shipping_address->shipping_charge) }}</td>
			        </tr>
			        ...
			        <!--</tr>-->
			        <tr>
			            <th class="text-left strong">{{ translate('Grand Total (including tax)') }}</th>
