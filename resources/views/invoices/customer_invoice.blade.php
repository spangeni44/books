	...
	<div>
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
            <table>
				...
				<tr><td class="gry-color small"><b>@if(isset($shipping_address->inside_valley_address)) {{ucwords(str_replace('_',' ',@$shipping_address->inside_valley_address))}}, @else Outside Valley, @endif </b> {{ $shipping_address->address }}, @if(isset($shipping_address->district)) {{ $shipping_address->district }}, @endif {{ @$shipping_address->city }}, {{ @$shipping_address->country }}</td></tr>
				@if(isset($shipping_address->email))<tr><td class="gry-color small">{{ translate('Email') }}: {{ $shipping_address->email }}</td></tr>@endif
	        ...
	        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
		        <tbody>
			        ...
			        <tr>
			            ...
			            <td class="currency">{{ single_price(json_decode($order->shipping_address)->shipping_charge) }}</td>
			        </tr>
			        ...
			        <!--</tr>-->
			        <tr>
			            <th class="text-left strong">{{ translate('Grand Total') }}<span style="font-size:11px;">(including tax)</span></th>
