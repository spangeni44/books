...
@section('content')
<div>
    <h1 class="page-header text-overflow">{{ translate('Add New Book') }}</h1>
</div>
<div class="row">
	<div class="col-lg-8 col-lg-offset-2">
		<form class="form form-horizontal mar-top" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="text" class="form-control" name="name" placeholder="{{ translate('Book Name') }}" onchange="update_sku()" required>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Book Version')}}</label>
						<div class="col-lg-7">
							<input type="number" class="form-control" name="book_version">
						</div>
					</div>
					<div class="form-group">
			...
			<div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">{{translate('Book Videos')}}</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
			...
			<div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">{{translate('Book Variation')}}</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<div class="col-lg-2">
					...
					<div>
						<p>{{ translate('Choose the attributes of this Book and then input values of each attribute') }}</p>
						<br>
					</div>
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group" id="warrenty">
						...
						<div class="col-lg-7">
							<input type="text" placeholder="{{ translate('warrenty') }}" name="warrenty" class="form-control">
						</div>
					</div>
				</div>
			</div>
			<div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">{{translate('Book Short Description')}}</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Short Description')}}</label>
						<div class="col-lg-9">
							<textarea class="editor" id="editor" name="excerpt"></textarea>
						</div>
					</div>
				</div>
			</div>
            ...
            @if (\App\BusinessSetting::where('type', 'shipping_type')->first()->value == 'product_wise_shipping')
                <div class="panel">
    				<div class="panel-heading bord-btm">
    					<h3 class="panel-title">{{translate('Book Shipping Cost')}}</h3>
    				</div>
    				<div class="panel-body">
			...
			<div class="mar-all text-right">
				<button type="submit" name="button" class="btn btn-info">{{ translate('Add New Book') }}</button>
			</div>
		</form>
	</div>
</div>
