...
@section('content')
<div>
    <h1 class="page-header text-overflow">{{ translate('Edit Book') }}</h1>
</div>
<div class="row">
		...
		<form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
						...
						<div class="col-lg-7">
							<input type="number" class="form-control" name="book_version" value="{{@$product->book_version}}">
						</div>
					</div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">{{translate('Book Author(s)')}}</label>
                        <div class="col-lg-7">
                            <input type="text" class="form-control" name="author_name[]" id="author_name" value="{{ $product->author_name }}" placeholder="{{ translate('Type to add a author_name') }}" data-role="tagsinput">
                        </div>
                    </div>
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<br>
					<div class="form-group">
					    <!--class=" sku_combination" id="sku_combination"-->
                        <label class="col-lg-2 control-label">{{translate('SKU')}}</label>
						<div class="col-lg-7">
							<input type="text"  name="sku" value="{{@$product->sku}}" placeholder="{{ translate('SKU') }}" class="form-control">
						</div>
					</div>
					<div class="form-group" id="warrenty">
						<label class="col-lg-2 control-label">{{translate('warrenty')}}</label>
						<div class="col-lg-7">
							<input type="text" name="warrenty" value="{{@$product->warrenty}}" placeholder="{{ translate('warrenty') }}" class="form-control">
						</div>
					</div>
			...
			<div class="panel">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-lg-9">
							<textarea class="editor" name="excerpt">{{$product->excerpt}}</textarea>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	// 	        if(this.value == '{{$product->publication_id}}'){
