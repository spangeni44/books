...
@if($type != 'Seller')
    <div class="row">
        <div class="col-lg-12 pull-right">
            <a href="{{ route('products.create')}}" class="btn btn-rounded btn-info pull-right">{{translate('Add New Book')}}</a>
        </div>
    </div>
@endif
...
<div class="panel">
    ...
    <div class="panel-heading bord-btm clearfix pad-all h-100">
        <h3 class="panel-title pull-left pad-no">{{ translate($type.' Book') }}</h3>
                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    @endif
                                    <li><a href="{{route('products.deleteProduct',@$product->id)}}" onClick="confirm('Are you sure you want to delete this product?');">{{translate('Delete')}}</a></li>
                                    <!--confirm_modal('{{route('products.destroy', $product->id)}}');-->
