    ...
    <div class="panel">
        ...
        <form class="form-horizontal" action="{{ route('subcategories.update', $subcategory->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{translate('Category Image')}}</label>
                    <div class="col-sm-9">
                        <input type="file" accept="image/*" name="image">
                    </div>
                     @if(isset($subcategory->image))
                            <div class="col-sm-4">
                                <img src="{{asset('public/uploads/sub-categories/'.@$subcategory->image)}}" class="img img-responsive img-thumbnail">
                            </div>
                    @endif
                </div>
                <div class="form-group">
