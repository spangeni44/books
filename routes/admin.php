...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::post('/categories/top_cat', 'CategoryController@updatetop_cat')->name('categories.top_cat');
	...
	Route::delete('/subsubcategories/destroy/{id}', 'SubSubCategoryController@destroy')->name('subsubcategories.destroy');
...
// 	Route::delete('/brands/destroy/{id}', 'BrandController@destroy')->name('brands.destroy');
	...
	Route::delete('/publications/destroy/{id}', 'PublicationController@destroy')->name('publications.destroy');
	
	Route::resource('blogs','BlogController');
	Route::delete('/blogs/destroy/{id}', 'BlogController@destroy')->name('blogs.destroy');
	Route::post('/blogs/update-status', 'BlogController@updateStatus')->name('blogs.update_status');
	...
	Route::get('/products/delete/{id}','ProductController@deleteProduct')->name('products.deleteProduct');
	...
	Route::delete('/sellers/destroy/{id}', 'SellerController@destroy')->name('sellers.destroy');
	...
	Route::group(['prefix' => 'frontend_settings'], function(){
	    ...
	    Route::delete('/sliders/destroy/{id}', 'SliderController@destroy')->name('sliders.destroy');
	    ...
	    Route::delete('/home_banners/destroy/{id}', 'BannerController@destroy')->name('home_banners.destroy');

		Route::resource('home_categories','HomeCategoryController');
	    Route::delete('/home_categories/destroy/{id}', 'HomeCategoryController@destroy')->name('home_categories.destroy');
    ...
    Route::delete('/staffs/destroy/{id}', 'StaffController@destroy')->name('staffs.destroy');

	Route::resource('flash_deals','FlashDealController');
    Route::delete('/flash_deals/destroy/{id}', 'FlashDealController@destroy')->name('flash_deals.destroy');
...
// 	Route::get('/orders/delete/{id}', 'OrderController@delete')->name('orders.delete');
	...
	Route::delete('/links/destroy/{id}', 'LinkController@destroy')->name('links.destroy');
	...
	Route::delete('/customer_packages/destroy/{id}', 'CustomerPackageController@destroy')->name('customer_packages.destroy');
	//Classified Products
